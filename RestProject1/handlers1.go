...
func (s *APIServer1) handleGreet(w http.ResponseWriter, r *http.Request) {
...
func (s *APIServer1) handleLogin(w http.ResponseWriter, r *http.Request) {
...
func (s *APIServer1) handleIntrospect(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		w.WriteHeader(400) //Response code for bad request
		w.Write([]byte("Method not supported"))
		return
...
func (s *APIServer1) handleGetPost(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		w.WriteHeader(400) //Response code for bad request
		w.Write([]byte("Method not supported"))
		return
...
func (s *APIServer1) handleGetPostById(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		w.WriteHeader(400) //Response code for bad request
		w.Write([]byte("Method not supported"))
		return
...
func (s *APIServer1) handleCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	//json.NewEncoder(w).Encode(res) ---> In case we want to print the post being created on browser/Postman. Check this once.
...
/*
SAMPLE CALLS USED TO CREATE POST HANDLER WHICH TAKE INPUTS FROM THE BODY ON WEBPAGE/POSTMAN AND CREATES AN OBJECT USING POST REQUEST.
package main
